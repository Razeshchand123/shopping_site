...
<div class="main">
            ...
            <li class="hassubs"><a href="#" wire:click.prevent="$emit('postAdded','cloth')">cloth</a>
                ...
                <li class="hassubs"><a href="#">shoes</a>
                    <ul class="dropdown-menuwala">
                        
                        <li class="subs hassubs"><a href="#">male</a>
                            <ul class="dropdown-menuwala">
                                <li class="subs"><a href="#">sports</a></li>
                                <li class="subs"><a href="#">party</a></li>
                                <li class="subs"><a href="#">casule</a></li>
                                <li class="subs"><a href="#">boot</a></li>
                ...
                <li class="hassubs"><a href="#">Accessories</a>
                    <ul class="dropdown-menuwala">
                        
                        <li class="subs hassubs"><a href="#">male</a>
                            <ul class="dropdown-menuwala">
                            
                                <li class="subs"><a href="#">sunglass</a></li>
                                <li class="subs"><a href="#">watches</a></li>
                                <li class="subs"><a href="#">Jewellery</a></li>
                                <li class="subs"><a href="#">bags</a></li>
                                <li class="subs"><a href="#">wallet</a></li>
                                <li class="subs"><a href="#">others</a></li>
                            </ul>
                        </li>
                        <li class="subs hassubs"><a href="#">female</a>
