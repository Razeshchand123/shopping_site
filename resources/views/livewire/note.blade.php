      ...
      <img src='{{Storage::url($value->slogo)}}' alt="no img" class="img-fliud" height="200"/>
       ...
       @endif
        ...
        <input type="text" placeholder="समान को नाम" class="form-control" wire:model="pname">
                 ...
                 <input type="number" placeholder="समान को मुल्य" class="form-control" wire:model="price">  <br>  
...
<small class="text-danger">यसमा काम हुदै छ| ..</small>
   ...
   @else
   <small>no catagories selected</small>
...
"paslname"=>"required|max:25|min:3",
      "pasladress"=>"required|max:35|min:5",
      "paslowner"=>"required|max:10|min:3",
      "paslnumber"=>"required|max:10|min:10",
      "paslemail"=>"required|email|max:20",